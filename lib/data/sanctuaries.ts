...
location: string;  
image: string;  
description: string; // The "Narrative" field the UI is requesting  
highlights: string[];  
intelligence: string;  
atmosphere: string;  
}
...
{  
  ...
  location: "Utah, USA",  
  image: "https://images.unsplash.com/photo-1504851149312-7a075b496cc7",  
  description: "A stone-and-concrete masterpiece integrated into the stark beauty of the Utah desert, where structure meets geology.",  
...
{  
  ...
  image: "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2",  
  description: "A dramatic coastal escape perched on the cliffs of Big Sur, where architecture acts as a spectator to the Pacific's violence.",  
...
{  
  ...
  description: "A remote Icelandic hideaway focused on adventure and thermal recovery, buried beneath a living roof in the Nordic void.",  
...
{  
  ...
  description: "A vertical retreat at the apex of the Otemachi Tower, blending urban power with the serene silence of a mountain monastery.",  
...
{  
  ...
  description: "An over-water playground defined by its commitment to sustainable luxury and the pursuit of slow life on the azure horizon.",  
...
{  
  ...
  description: "A wild and rugged estate on Sumba Island, where the edge of the world feels tangible and the surf is truly solitary.",  
...
{  
  ...
  description: "A conservation-first sanctuary on the edge of the park, providing a fragile, high-value connection to the mountain gorillas.",  
...
{  
  ...
  image: "https://images.unsplash.com/photo-1473580044384-7ba9967e16a0",  
  description: "A stilted luxury camp in the Namib desert, channeling the spirit of early 20th-century expeditions into the great void.",  
...
{  
  ...
  description: "A secret forest sanctuary where moss-covered stones and ancient paths define the luxury of hidden history.",  
...
{  
  ...
  description: "A spiritual journey through five high-altitude lodges, each offering a distinct perspective on the Himalayan Kingdom.",  
...
{  
  ...
  description: "An iconic safari outpost in the salt pans where silence is the primary asset and the horizon is a permanent fixture.",  
...
{  
  ...
  description: "Architectural shipwrecks stranded on the haunting dunes of the Skeleton Coast, offering shelter at the world's terminal edge.",  
...
{  
  ...
  description: "The world's first 3D-printed sanctuary, merging cutting-edge material science with the fluid life of the Indian Ocean.",  
...
{  
  ...
  description: "A sustainable luxury atoll that serves as a living laboratory for oceanic health and ultimate South Pacific privacy.",  
...
{  
  ...
  description: "A dedicated sanctuary for weightless wellbeing, where architecture is tuned to the frequency of human recovery.",  
...
{  
  ...
  description: "The most exclusive gateway to the Antarctic interior, where luxury pods provide a base for exploring the cosmic white silence.",  
...
{  
  ...
  description: "A limestone fortress overlooking the deep canyons of the Al Hajar Mountains, defined by rugged stone and desert nobility.",  
...
{  
  ...
  description: "High-spec tented luxury immersed in the Costa Rican rainforest, where the volcano's presence is constant and powerful.",  
