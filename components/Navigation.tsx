...
<div  
className={`fixed top-0 right-0 h-full w-full max-w-md z-50 bg-[#2A2A2A] border-l border-[#D4AF37]/20 shadow-2xl transform transition-transform duration-300 ease-in-out flex flex-col justify-between p-8 md:p-12 ${  
...
{/* Navigation Links */}  
<nav className="flex flex-col space-y-3 my-auto py-6 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">  
{navLinks.map((link, i) => (  
<Link  
key={i}  
href={link.path}  
...
{/* Drawer Footer */}  
<div className="pt-6 border-t border-white/10 flex items-center justify-between text-[11px] text-white/40 shrink-0">  
