export type Sanctuary = {  
  ...
  location: string;  
  tagline: string;  
  categoryDescription: string; // Renamed from 'description' to fix the build  
  heroImage: string;  
  atmosphere: string[];  
  highlights: string[];  
 ...
 export const sanctuaries = SANCTUARIES_DATA;  
  {  
    ...
    categoryDescription: "A collection of sky-high retreats and historic urban landmarks. Designed for the traveler who finds peace in the energy of the world's greatest capitals.",  
  ...
  {  
    ...
    categoryDescription: "Built into cliffsides and hidden in valley folds. These are safe havens where privacy is the ultimate luxury and the outside world ceases to exist.",  
  ...
  {  
    ...
    categoryDescription: "Over-water villas and ultra-luxury yachts that move with the tide. For those who believe the best view is one that never stays the same.",  
  ...
  {  
    ...
    categoryDescription: "Luxury camps and desert estates where the silence is profound and the stars are brighter than anywhere else on Earth.",  
  ...
  {  
    ...
    categoryDescription: "Authentic connection to the wild without sacrificing a single comfort. Witness the rhythm of nature from your own private deck.",  
  ...
  {  
    ...
    categoryDescription: "Ski-in/ski-out chalets and glass-walled lodges where the snow is pristine and the fires are always roaring.",  
  ...
  {  
    ...
    categoryDescription: "White sands and turquoise waters. These island retreats are for those who want to disappear into the sun and sea.",  
  ...
  {  
    ...
    categoryDescription: "Properties that have served as backdrops for cinema's greatest moments. Experience the glamour of the silver screen in person.",  
  ...
  {  
    ...
    categoryDescription: "Ultra-luxe accommodation situated within or overlooking the world's most prestigious sporting venues and event centers.",  
