...
const pillars = [
  ...
  { number: "02", title: "Intelligence", subtitle: "The Curated Standard", body: "We vet for what cannot be measured. From structural privacy to discreet service alignment, every property and partner is audited to ensure your absolute sanctuary." },
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto border-b border-white/10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/70 text-sm md:text-base leading-relaxed font-sans font-light">
              Our background spans complex multi-jurisdictional logistics, off-market estate sourcing, and family
              office travel stewardship — translating high-stakes itineraries into the invisible
