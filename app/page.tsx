  ...
  <main className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">      
    ...
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-transparent">      
      ...
      <div className="relative z-20 text-center px-6 max-w-5xl animate-in fade-in duration-1000">      
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif tracking-[0.2em] uppercase text-[#c5a059] mb-6 drop-shadow-2xl bg-transparent">      
          The Art of Discerning Travel      
        </h1>      
        <p className="text-lg md:text-xl font-light tracking-widest text-zinc-300 uppercase max-w-3xl mx-auto bg-transparent">      
    ...
    <section className="py-12 border-y border-[#c5a059]/10 bg-[#0d0d0d]">      
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">      
        <div>      
          <p className="text-sm tracking-widest font-light text-zinc-400 bg-transparent">24/7 GLOBAL CONCIERGE</p>      
        </div>      
        <div className="border-x border-[#c5a059]/10">      
          <p className="text-sm tracking-widest font-light text-zinc-400 bg-transparent">OFF-MARKET PROPERTIES</p>      
        </div>      
        <div>      
          <p className="text-sm tracking-widest font-light text-zinc-400 bg-transparent">TAILORED ITINERARIES</p>      
        </div>      
      </div>      
    </section>
      ...
      <div className="max-w-7xl mx-auto">      
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">      
          <div className="bg-transparent">      
            <span className="text-[#c5a059] tracking-[0.4em] uppercase text-xs mb-4 block italic bg-transparent">Curated Collection</span>      
            <h2 className="text-4xl font-serif text-white uppercase tracking-tighter bg-transparent">Featured Properties</h2>      
          </div>      
          <Link href="/archive" className="text-[#c5a059] text-xs tracking-[0.3em] uppercase border-b border-[#c5a059]/30 pb-1 hover:border-[#c5a059] transition-all bg-transparent">      
            View Entire Ledger      
          </Link>      
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">      
          {properties.map((prop) => (      
            <Link key={prop.id} href={`/sanctuaries/${prop.id}`} className="group block bg-transparent">      
              <div className="relative aspect-[4/5] overflow-hidden bg-zinc-900 mb-6">      
                <img       
                  src={prop.img}       
                  alt={prop.name}      
                  className="object-cover w-full h-full transition-all duration-700 scale-100 group-hover:scale-110 grayscale-0 md:grayscale group-hover:grayscale-0 opacity-100 md:opacity-60 group-hover:opacity-100"      
                />      
                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a] via-transparent to-transparent opacity-60" />      
              </div>      
              <h3 className="text-xl font-serif tracking-tight mb-1 text-white bg-transparent">{prop.name}</h3>      
              <p className="text-xs tracking-[0.2em] text-zinc-500 uppercase bg-transparent">{prop.loc}</p>      
            </Link>      
          ))}      
        </div>      
      </div>      
    ...
    <section className="py-24 bg-[#0d0d0d] relative">      
      <div className="max-w-4xl mx-auto text-center px-6">      
        ...
        <span className="text-[#c5a059] tracking-[0.5em] uppercase text-xs mb-6 block bg-transparent">Editorial Perspective</span>      
        <h2 className="text-3xl md:text-5xl font-serif italic mb-8 bg-transparent">The ROI of Reset</h2>      
        <p className="text-zinc-400 font-light leading-relaxed mb-12 max-w-2xl mx-auto bg-transparent">      
