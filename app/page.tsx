...
// Define the interface to match our Elite Ledger property structure  
interface Property {  
id: string;  
name: string;  
location: string;  
...
// We take the first 9 properties from the 19 available in PROPERTY_DATA  
const featuredProperties = (PROPERTY_DATA as unknown as Property[]).slice(0, 9);
