...
// Helper to find sanctuary name for the metadata  
...
return (  
  <main className="min-h-screen bg-[#0A0A0A] text-white selection:bg-[#C5A059]/30 relative">  
    {/* NUCLEAR FIX: Permanent override for ghost backgrounds */}  
    <style dangerouslySetInnerHTML={{ __html: `  
      ...
      * { background-image: none !important; }  
      ...
      .btn-brass { border-color: rgba(197, 160, 89, 0.3) !important; }  
    `}} />
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden border-b border-[#C5A059]/10">  
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">  
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-20 text-[10px] tracking-[0.4em] font-bold uppercase text-[#C5A059]/60">  
          <span className="hover:text-[#C5A059] transition-colors">24/7 Global Concierge</span>  
          <span className="hover:text-[#C5A059] transition-colors">Off-Market Access</span>  
          <span className="hover:text-[#C5A059] transition-colors">Tailored Itineraries</span>  
        </div>  
      </div>  
    </section>
    ...
    <section className="py-32 px-6 md:px-12 max-w-[1600px] mx-auto">  
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-16 gap-y-28">  
        {featuredProperties.map((property, idx) => (  
          ...
          >  
            <div className="image-container relative aspect-[4/5] overflow-hidden mb-8">  
              <Image  
    ...
    <section className="py-40 bg-[#0D0D0D] border-y border-[#C5A059]/5 relative overflow-hidden">  
      <div className="max-w-4xl mx-auto text-center px-6 relative z-10">  
        ...
        <Link   
          href="/concierge"  
          className="btn-brass inline-block px-16 py-5 border text-[11px] tracking-[0.4em] uppercase hover:bg-[#C5A059] hover:text-black transition-all duration-700 ease-in-out"  
        >  
          Begin Intake  
        </Link>  
      </div>  
