...
<main className="min-h-screen bg-[#0A0A0A] text-white selection:bg-[#C5A059]/30 pt-32 pb-24 px-6 md:px-12">    
  <div className="max-w-4xl mx-auto space-y-12">    
    ...
    <section className="space-y-4">    
      ...
      <p className="text-white/70 text-sm md:text-base leading-relaxed">    
        Sensitive travel itineraries, security routing details, and personal preferences are retained only for the duration required to execute active mandates. Post-journey security metadata is purged on a defined schedule unless specifically retained under active client advisory agreements.    
      </p>    
    </section>

    <section className="space-y-4">    
      <h2 className="text-xl font-medium text-[#C5A059] tracking-wide">03. Confidential, Need-to-Know Data Sharing</h2>    
      <p className="text-white/70 text-sm md:text-base leading-relaxed">    
        When interfacing with vetted security partners, private aviation operators, and unlisted estate properties, client profile data is shared solely on a strict need-to-know basis under binding confidentiality covenants. We never monetize or broker member data.    
      </p>    
    </section>
    ...
    <section className="space-y-4">    
      ...
      <p className="text-white/70 text-sm md:text-base leading-relaxed">    
        For inquiries regarding personal data sovereignty or secure profile management, contact our Data Protection Officer directly at <span className="text-[#C5A059]">daryl.clark@fora.travel</span>.    
      </p>    
    </section>
