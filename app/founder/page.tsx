...
export const metadata = {  
  ...
  description:  
    'Meet Daryl Clark, Founder & Principal of NexVoyage Collective—a private travel office for clients who value discretion, depth, and thoughtful access.',  
}
...
const disciplines = [  
  {  
    ...
    description:  
      'Discreet logistical planning for sensitive or remote journeys across complex geographies.',  
  },  
  {  
    number: '02',  
    title: 'Off-Market Estate Sourcing',  
    description:  
      'Relationships with private islands and residences beyond standard public inventory, unlisted historic palazzos, and wilderness reserves.',  
  },  
  {  
    number: '03',  
      ...
      <main className="mx-auto max-w-7xl px-6 pb-24 pt-32 md:px-12">  
        ...
        <section className="mb-32 grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">  
          ...
          <div className="lg:col-span-7">  
            ...
            <h1 className="mb-10 font-serif text-5xl font-light leading-[0.95] tracking-[-0.06em] md:text-7xl">  
              Daryl  
              <br />  
              Clark  
            </h1>
            ...
            <div className="space-y-6 font-sans text-lg font-light leading-[1.85] text-white/70">  
              <p>  
                NexVoyage Collective is built on decades of executive leadership and complex logistics—from sub-polar archipelagos to private wildlife concessions in the Okavango. It was founded on a singular, uncompromising thesis:{' '}  
              ...
              <p>  
                Our work transcends traditional concierge service. We operate at the intersection of complex, detail-sensitive logistics, unlisted estate access, and family office travel stewardship, transforming complex global movements into careful coordination. Whether orchestrating multi-generational journeys across continents, identifying properties beyond standard public inventory, or managing the precise sequencing of overlapping schedules and unspoken expectations, we solve problems that most concierge services don&apos;t know exist.  
              </p>

              <p>  
                Arrival, for us, means stepping into an experience that has already begun—one where every detail has been anticipated, every complexity dissolved, and every transition engineered to feel natural. It means your family office runs seamlessly across time zones. It means your private retreat is waiting exactly as envisioned. It means the machinery of travel becomes entirely invisible, and you simply belong wherever you are.  
              </p>

              <p>  
                We work with a limited number of clients who demand the uncommon, who understand that discretion and depth of knowledge matter more than volume, and who recognize that the best travel experiences are built on relationships, not transactions.  
              </p>  
            </div>
            ...
            <blockquote className="my-12 border-l border-[#C5A059] py-2 pl-6 font-serif text-xl italic leading-relaxed text-white/90 md:text-2xl">  
              &ldquo;Discretion is not merely the absence of exposure; it is the presence of greater control over the details of your environment.&rdquo;  
            </blockquote>  
          </div>  
        </section>
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-12 md:gap-16">  
            ...
            <div className="md:col-span-8">  
              <p className="max-w-4xl text-3xl font-light leading-tight tracking-tight text-white/90 md:text-5xl">  
                The finest journeys are not assembled from options. They are constructed from understanding.  
              </p>  
            </div>  
          </div>  
        </section>
        ...
        <section className="mb-32">  
          <div className="mb-16 max-w-2xl">  
            ...
            <p className="mt-6 font-sans text-base font-light leading-relaxed text-white/55">  
              The visible itinerary is only one layer of the work. The real value lies in the infrastructure beneath it.  
            </p>  
          </div>
        ...
        <section className="mb-32 border-t border-white/10 pt-20">  
          <div className="mb-16 max-w-2xl">  
            ...
            <p className="mt-6 font-sans text-base font-light leading-relaxed text-white/55">  
              Our relationships are carefully maintained over time. They are not simply booking channels; they are the foundation for access, recognition, and precise execution.  
            </p>  
          </div>
