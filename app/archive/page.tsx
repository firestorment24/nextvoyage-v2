          ...
          <div className="relative aspect-[4/5] bg-neutral-900 mb-8 overflow-hidden border border-[#C5A059]/10 transition-all duration-700 group-hover:border-[#C5A059]/40">  
            {property.image ? (  
              <img   
                src={property.image}   
                alt={property.name}  
                /* Default: Full Color | Hover: Grayscale */  
                className="w-full h-full object-cover opacity-90 transition-all duration-700 group-hover:scale-105 group-hover:grayscale group-hover:opacity-60"  
              />  
            ) : (  
