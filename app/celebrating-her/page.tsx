...
const journeys = [
  {
    ...
    image: 'https://cdn.marblism.com/8f0Q4_uKAAF.webp',
    alt: 'Women sharing an evening celebration at a candlelit vineyard table in Mendoza',
  },
  {
    number: '02',
    title: 'The Next Chapter',
  ...
  },
  {
    ...
    image: 'https://cdn.marblism.com/Ce0xq7Grwxi.webp',
    alt: 'Women sharing wine on a sunlit terrace in Puglia',
  },
  {
    number: '04',
    ...
    image: 'https://cdn.marblism.com/usud5-W9P1o.webp',
    alt: 'Mother and daughter sharing a quiet moment in a luxury villa',
  },
  {
    number: '05',
    ...
    image: 'https://cdn.marblism.com/uDxOTr-smRl.webp',
    alt: 'Women gathering in a warm heritage courtyard in Ghana',
  },
  {
    number: '06',
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-24 md:grid-cols-[0.9fr_1.1fr] md:px-12 md:py-32">
          ...
          <div className="space-y-6 font-sans text-sm leading-relaxed text-[#071421]/70 md:text-base">
            <p>
              ...
              planning relationship for the journey: aligning accommodations,
              transportation, experiences, dining, celebration details, and
              traveler logistics around one thoughtfully designed itinerary.
            </p>

            <p className="text-[#071421]">
              You remain at the heart of the gathering. We take care of
