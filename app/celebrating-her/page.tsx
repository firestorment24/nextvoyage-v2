...
const servicePoints = [  
'Occasion-led journey design',  
'Curated luxury accommodations',  
'Private transportation and thoughtfully selected experiences',  
'Wellness and restorative elements where appropriate',  
'Private dining and celebration planning',  
'Professional photography and personalized details where requested',  
'Group coordination for families, friends, chapters, and professional organizations',  
'Dedicated planning from initial concept through travel',  
];
