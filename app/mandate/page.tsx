...
<main className="min-h-screen bg-[#0A0A0A] text-white font-serif selection:bg-[#D4AF37] selection:text-black">
  ...
  <section className="relative h-[70vh] md:h-[80vh] w-full flex items-center justify-center overflow-hidden">  
    ...
    <div className="relative z-10 text-center px-6 max-w-4xl mt-12">  
      ...
      <p className="text-white/70 text-base md:text-lg font-light tracking-wide max-w-2xl mx-auto font-sans">  
        We don&apos;t just plan travel—we create private journeys for clients who value exceptional properties, discretion, and having every detail handled.  
      </p>  
    </div>  
  </section>
  ...
  <section className="py-24 px-6 max-w-4xl mx-auto text-center border-b border-white/10">  
    ...
    <blockquote className="text-white/80 text-xl md:text-2xl font-light leading-relaxed italic mb-8">  
      True luxury is the absence of friction. It is knowing that every detail has been accounted for before you even thought to ask, and that your privacy remains absolute wherever you go.  
    </blockquote>  
  ...
  <section className="py-28 px-6 max-w-6xl mx-auto space-y-32">
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">  
      <div className="space-y-6">  
        ...
        <h2 className="text-3xl md:text-4xl font-light tracking-tight text-white">  
          Discreet, Private Coordination  
        </h2>  
        <p className="text-white/60 text-sm md:text-base leading-relaxed font-sans font-light">  
          In an age of constant exposure, privacy matters more than ever. We work under strict non-disclosure agreements, coordinating private aviation, secure ground transport, and quiet arrivals without unnecessary digital traces. Your itinerary remains yours.  
        </p>  
      </div>  
      <div className="relative aspect-[4/3] overflow-hidden border border-white/10">  
        <Image  
          src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200&q=80"  
          alt="Discreet, Private Coordination"  
          fill  
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">  
      ...
      <div className="space-y-6 order-1 md:order-2">  
        ...
        <p className="text-white/60 text-sm md:text-base leading-relaxed font-sans font-light">  
          The world&apos;s finest properties are rarely found on public booking sites. Through decades of relationships with property owners, private family offices, and estate curators, we open doors that standard agencies cannot reach.  
        </p>  
      </div>  
    </div>
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">  
      <div className="space-y-6">  
        ...
        <h2 className="text-3xl md:text-4xl font-light tracking-tight text-white">  
          A Capped Roster of Clients  
        </h2>  
        <p className="text-white/60 text-sm md:text-base leading-relaxed font-sans font-light">  
          We deliberately limit how many clients we take on. That means every journey gets our full attention, prompt communication, and careful oversight by senior advisors—not a busy booking desk.  
        </p>  
      </div>  
      <div className="relative aspect-[4/3] overflow-hidden border border-white/10">  
        <Image  
          src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&q=80"  
          alt="A Capped Roster of Clients"  
          fill  
          className="object-cover opacity-70 hover:scale-105 transition-transform duration-700"  
        />  
      </div>  
  ...
  <section className="py-24 border-t border-white/10 text-center px-6 bg-[#0E0E0E]">  
    <div className="max-w-xl mx-auto space-y-6">  
      ...
      <p className="text-white/50 text-sm leading-relaxed font-sans font-light">  
        We invite discerning travelers and family offices to discuss their upcoming journeys with our team.  
      </p>  
      <div className="pt-4">  
        <Link  
