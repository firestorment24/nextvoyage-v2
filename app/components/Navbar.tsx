  ...
  return (  
    <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-sm border-b border-zinc-100">  
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">  
        <Link href="/" className="text-xl font-light tracking-[0.2em] hover:opacity-70 transition-opacity">  
...
Now, update your app/layout.tsx to include the Navbar. This ensures it appears on every page:

// app/layout.tsx  
import './globals.css'  
import { Inter } from 'next/font/google' // We'll upgrade typography next  
  ...
  return (  
    <html lang="en">  
      <body className={inter.className}>  
        <Navbar />  
        <main className="pt-20"> {/* Adding padding so content isn't hidden under the fixed nav */}  
          {children}  
        </main>  
