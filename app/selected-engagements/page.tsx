...
export default function SelectedEngagementsPage() {  
  return (  
    <main className="min-h-screen bg-[#0A0A0A] text-white font-serif selection:bg-[#D4AF37] selection:text-black">
      ...
      {/* Hero */}  
      <section className="relative py-32 md:py-48 px-6 text-center border-b border-white/5">  
        <div className="max-w-3xl mx-auto">  
          <span className="text-[#D4AF37] text-[10px] uppercase tracking-[0.3em] font-sans">  
            The Record  
          </span>  
          <h1 className="text-[#D4AF37] text-4xl md:text-6xl font-light tracking-tight mt-6 mb-6">  
            Selected Engagements  
          </h1>  
          <p className="text-white/50 text-sm md:text-base leading-relaxed font-sans font-light max-w-2xl mx-auto">  
