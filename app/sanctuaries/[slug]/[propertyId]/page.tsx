...
// Local interface to match our needs  
interface Property {  
id: string;  
name: string;  
location: string;  
...
// Double casting (as unknown as Property[]) to bypass the strict overlap check  
const property = (properties as unknown as Property[]).find(p => p.id === params.propertyId);
